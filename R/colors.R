...
wacolors = list(
    ...
    # CONTINUOUS
    sound_sunset = c("#001F39", "#1E2654", "#412A6B", "#5E3075", "#714174",
                     "#805177", "#90627C", "#A07283", "#D17188", "#E88083",
                     "#F99278", "#FFA868", "#FFBF5E", "#FFD867", "#FFF07A"),
    ...
    sea = c("#1C163A", "#1C2350", "#113264", "#004276", "#005179", "#225F7E",
            "#376D84", "#497B8C", "#5B8A95", "#6B99A0", "#7BA7AB", "#8BB7B6",
            "#9BC6C2", "#ABD6CE", "#BBE6DB"),
    ...
    vantage = c("#5C3770", "#575A87", "#547998", "#5E97A4", "#79B2AF",
                "#A0CCBC", "#CAE4D0", "#F2FDE9", "#D3E59E", "#C6C86B",
                "#BAA935", "#AC8B1E", "#996E17", "#855213", "#70370F")
)
